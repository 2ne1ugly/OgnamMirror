...
protoc -I %~dp0\Proto --grpc_out=%~dp0\Plugins\InfraworldRuntime\Source\InfraworldRuntime\Layton --plugin=protoc-gen-grpc=%~dp0\Proto\grpc_cpp_plugin.exe layton.proto
